<%-- 
    Document   : checkout
    Created on : Feb 3, 2017, 5:15:53 AM
    Author     : Janakshi
--%>
        ...
        <c:import url="header.jsp"/>      
         ...
         <section class="content">
            ...
            <div class="login-box-body">
              ...
              <p class="login-box-msg">Checkouts for each ticket</p>
              ...
              <c:choose>
                        ...
                        <c:when test="${'1' eq sessionScope.cStatus}">
                            <div class="alert alert-success alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <h4><i class="icon fa fa-check"></i> Checkout Success!</h4>
                                Your Refund: Rs. ${requestScope.refund}
                          </div>
                            <c:remove var="cStatus" scope="session" />
                           
                        </c:when>                                  
                        <c:when test="${'2' eq sessionScope.cStatus}">
                            <div class="alert alert-danger alert-dismissible">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <h4><i class="icon fa fa-warning"></i> Checkout Failed!</h4>
