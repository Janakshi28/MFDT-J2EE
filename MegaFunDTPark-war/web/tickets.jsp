<%-- 
    Document   : tickets
    Created on : Jan 22, 2017, 11:48:02 PM
    Author     : Janakshi
--%>
         ...
         <c:import url="header.jsp"/>
            ...
            <div class="login-box">
                ...
                <div class="login-box-body">
                  ...
                  <form action="./IssueTicketServlet" method="post">
                    <div class="form-group has-feedback">                       
                      <input type="text" class="form-control" name="adult"  placeholder="Number of adult tickets">
                      <span class="fa fa-user-times form-control-feedback"></span>
                    </div>
                      <div class="form-group has-feedback">                       
                      <input type="text" class="form-control" name="child" placeholder="Number of child tickets">
                      <span class="fa fa-user-times form-control-feedback"></span>
                    </div>
                      <div class="form-group has-feedback">                       
                  ...
                  <c:choose>
                            ...
                            <c:when test="${'1' eq sessionScope.issueStatus}">
                                <div class="alert alert-success alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4><i class="icon fa fa-check"></i> Ticket Issue Success!!</h4>
                                        Your E-band IDs: <br/>
                                    <c:forEach var="row" items="${sessionScope.ebands}">
                                        Band ID: <c:out value="${row.bandid}"/> <br/>
                                    </c:forEach>
                                        
                              </div>
                                <c:remove var="issueStatus" scope="session" />
                                <c:remove var="ebands" scope="session" />
                            </c:when>                                  
                            <c:when test="${'2' eq sessionScope.issueStatus}">
                                <div class="alert alert-warning alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4><i class="icon fa fa-warning"></i> Ticket Issue Failed! Try Again...</h4>
                                      Please check all the fields again and provide valid values for each field.
                                 </div>
                                <c:remove var="issueStatus" scope="session" />
                            </c:when>
                             <c:when test="${'3' eq sessionScope.issueStatus}">
                                <div class="alert alert-warning alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4><i class="icon fa fa-warning"></i> Ticket Issue Failed! Try Again...</h4>
                   ...
                   <li>Ticket Prices:</li>
                        Child Ticket: Rs. 250.00 <br/>
                        Adult Ticket: Rs. 500.00 <br/>
                    <li>Initial Credit Amount for E-bands: Rs: 100.00 </li>
