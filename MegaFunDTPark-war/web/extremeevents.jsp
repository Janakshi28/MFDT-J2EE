<%-- 
    Document   : extremeevents
    Created on : Jan 23, 2017, 2:15:50 PM
    Author     : Janakshi
--%>
            ...
            <div class="login-box-body">
                 <c:choose>
                        ...
                        <c:when test="${user ne null }">
                            <p class="login-box-msg">Event payments for current session</p>
                        </c:when>
                        
                    </c:choose>
              <p class="login-box-msg">Pay for extreme events using e-payments</p>

              <form action="./EventPaymentServlet" method="post">
                 <div class="form-group has-feedback">
                      <input type="hidden" name="type" value="Event" /> 
                       <input type="hidden"  name="noOfItems" value="1">
                ...
                <div class="form-group has-feedback">                                 
                  ...
                  <select name="item" id="item" class="form-control" >
                         ...
                         <option value="Mad Swing">Mad Swing</option>
                        <option value="Heaven Jump">Heaven Jump</option>
                        <option value="Potter Ride">Potter Ride</option>
                        <option value="Avenger war">Avenger war</option>
                        <option value="Crazy Roller Coaster">Crazy Roller Coaster</option>
                        <option value="Color shots">Color shots</option>
                 </select>
                </div>
              ...
              <c:choose>
                        ...
                        <c:when test="${'1' eq sessionScope.bStatus}">
                            <div class="alert alert-success alert-dismissible">
                                ...
                                Payment for the event: Rs. ${requestScope.fee}
                          </div>
